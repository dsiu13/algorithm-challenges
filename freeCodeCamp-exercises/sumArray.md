...
## **1. Return the Largest Numbers in a Array With a For Loop**
...
## **2. Return the Largest Numbers in a Array With Built-In Functions — with map() and reduce()**
...
## **3. Return the Largest Numbers in a Array With Built-In Functions — with map() and apply()**
